...
ggplot(fin_comb_count) + 
  ...
  geom_area(aes(x=date, y= biden_count), 
             color = "darkblue", fill = "darkblue")+labs(title="Use of #JoeBiden (Blue) and #DonaldTrump (Red) (Final 3 Days of the Election)", 
         x="Date", y = "Count")
...
ggplot(data = fin_biden_day_count, aes(x = date, y = biden_count))+
  ...
  labs(title="Use of #JoeBiden Through the Final 3 Days 
       of the Election", 
         x="Date", y = "Count")
```  
...
ggplot(data = fin_trump_day_count, aes(x = date, y = trump_count))+
  geom_line(color = "red", size = 2)+labs(title="Use of #DonaldTrump 
                                          Through the Final 3 Days of the Election", 
         x="Date", y = "Count")
```  
...
ggraph(rt_g2, layout = 'linear', circular = TRUE) + 
  ...
  labs(title="Biden Twitter City Relationships", subtitle="Most tweeted city names labeled. Darkers edges == more mentions.") +
...
ggraph(rt_gt2, layout = 'linear', circular = TRUE) + 
  ...
  coord_fixed() +
  scale_size_area(trans="sqrt") +
  labs(title="Trump Twitter City Relationships", subtitle="Most tweeted city names labeled. Darkers edges == more mentions.") +
  theme_graph(base_family=font_rc) 
```
...
p<-ggplot(data=bid_words, aes(x=word, y=freq)) +
  ...
  theme_minimal()
p+ coord_flip()+ labs(title="Most Used Words in Biden Twitter", 
         x="Word", y = "Count")
```
...
p<-ggplot(data=trump_words, aes(x=word, y=freq)) +
  ...
  theme_minimal()
p+ coord_flip()+labs(title="Most Used Words in Trump Twitter", 
         x="Word", y = "Count")
